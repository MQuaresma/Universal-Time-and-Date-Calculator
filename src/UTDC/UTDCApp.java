...
public class UTDCApp {
    ...
    private static UTDCModel createData(){
        ...
        SlotModel sm1 = new SlotModel(LocalDateTime.of(2018,12,20,13,15), Duration.ofDays(2), "Atividades Natalícias");
        ...
        SlotModel sm2 = new SlotModel(LocalDateTime.of(2018,12,31,15,0), Duration.ofDays(1), "Passagem de ano");
